...
def chi_squared(f_exp, f_obs, f_obs_err=None, ddof: int = 0, N: int = None):
	"""
    ...
    f_obs :     array-like
        Observed values.
    f_obs_err : array-like or None, optional
        Uncertainties in observed values. If None, assume unit uncertainties.
    ddof :      int, optional
...
def reduced_chi_squared(f_exp, f_obs, f_obs_err=None, ddof: int = 0, N: int = None):
	chi2, p_value = chi_squared(f_exp=f_exp, f_obs=f_obs, f_obs_err=f_obs_err, ddof=ddof, N=N)
